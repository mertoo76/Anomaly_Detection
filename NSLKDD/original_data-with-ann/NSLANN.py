# -*- coding: utf-8 -*-
"""
Created on Sun Nov 11 21:08:05 2018
...
x_train=dataset.iloc[:,4:6]
x_train=np.append(x_train, dataset.iloc[:,22:24], axis=1)
...
x_test=datasetTest.iloc[:,4:6]
x_test=np.append(x_test, datasetTest.iloc[:,22:24], axis=1)
