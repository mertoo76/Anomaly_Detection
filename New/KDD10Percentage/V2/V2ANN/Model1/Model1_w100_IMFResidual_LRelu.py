# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 13:21:33 2018
...
classifier.add(Dense(output_dim = 60, init = 'uniform', activation = 'linear', input_dim = 8))

classifier.add(LeakyReLU(alpha=0.01))

#Adding a second hidden layer
classifier.add(Dense(output_dim = 60, init = 'uniform', activation = 'linear'))
...
#plot_model(classifier, show_shapes=True, to_file='../Model1_w100_IMFResidual_LRelu.png')
