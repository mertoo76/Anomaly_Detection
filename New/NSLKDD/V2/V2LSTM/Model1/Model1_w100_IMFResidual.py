...
#load x values
x_train=np.load("../../V2Data/window100/xData.npy")
x_test=np.load("../../V2Data/window100/xDataTest.npy")

#labels

tmp=pd.read_csv('../../../Data/KDDTrain+.csv',',')
...
#Test 
tmp=pd.read_csv('../../../Data/KDDTest+.csv',',')
